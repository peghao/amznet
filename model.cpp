...
//    this->params = (tensor **)malloc(2*sizeof(void*));
    ...
    // this->params[0] = rand_tensor(shape_W, 2);
    // this->params[1] = rand_tensor(shape_b, 2);
    this->params[0] = range_tensor(shape_W, 2, -0.05f, 0.05f);
    this->params[1] = range_tensor(shape_b, 2, -0.05f, 0.05f);
